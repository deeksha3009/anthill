...
from capstone.views import home,signin,signup,signout,dashboard,create_group,group_page,add_members,add_guides,updates,add_milestone,view_milestones,profile
